...
const TermsConditions = styled.article`
  height: 400px;
  overflow-y: auto;
...
export function Step5({ check, setCheck, onProgressChange }: Props) {
  return (
    <Fragment>
      ...
      <div className="custom-control custom-checkbox mt-3">
        <input
          ...
          className={`custom-control-input ${check ? 'is-valid' : 'is-invalid'}`}
        />
